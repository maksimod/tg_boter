...
taskkill /F /IM pythonw.exe /FI "COMMANDLINE eq *notifications\run_notification_processor.py*" 2>NUL
...
start "" /B pythonw notifications\run_notification_processor.py
